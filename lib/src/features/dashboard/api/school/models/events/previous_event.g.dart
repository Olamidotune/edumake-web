...
part of 'previous_event.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PreviousEvent _$PreviousEventFromJson(Map<String, dynamic> json) =>
    PreviousEvent(
...
Map<String, dynamic> _$PreviousEventToJson(PreviousEvent instance) =>
    <String, dynamic>{
      '_id': instance.id,
