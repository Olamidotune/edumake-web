...
class ExamTimeTableScreen extends StatelessWidget {
  ...
  static const String routeName = '/exam_timeTable_screen';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        title: AppStrings.examTimeTable,
        action: Builder(
          builder: (context) {
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context)
                      .pushNamed(AddExamTimeTableScreen.routeName);
                },
                  ...
                  children: [
                    ...
                    BlocBuilder<ExamBloc, ExamState>(
                      builder: (context, state) {
                        if (state.fetchExamTimetableStatus ==
