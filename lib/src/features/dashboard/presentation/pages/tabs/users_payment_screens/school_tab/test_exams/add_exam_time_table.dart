...
class AddExamTimeTableScreen extends StatefulWidget {
  const AddExamTimeTableScreen({super.key});

  static const String routeName = '/exam-time-table';

  @override
  State<AddExamTimeTableScreen> createState() => _AddExamTimeTableScreenState();
}

class _AddExamTimeTableScreenState extends State<AddExamTimeTableScreen> {
  ...
  Future<void> _uploadTimeTable(
    ...
    try {
      ...
      request.fields['title'] = timeTableTitleController.text.trim();
