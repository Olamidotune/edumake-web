...
//         final filePath =
//             '${directory.path}/edumake_csv_template_$timestamp.csv';

//         // Write the file
//         final file = File(filePath);
//         await file.writeAsString(csvContent);

//         print('Android file saved to: ${file.path}');
//         ToastService.toast('File saved to Downloads folder');
//         return;
//       }

//       // iOS and other platforms - use FilePicker
//       String? outputFilePath = await FilePicker.platform.saveFile(
//         dialogTitle: 'Save CSV File',
//         fileName: 'edumake_csv_template.csv',
...
//         ToastService.toast('File downloaded successfully');
//       } else {
//         ToastService.toast(
...
//       ToastService.toast(
//         'Something went wrong while downloading the file: $e',
//         ToastType.error,
//       );
//     }
//   }
