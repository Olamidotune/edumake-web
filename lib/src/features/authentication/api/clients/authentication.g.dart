...
class _AuthenticationClient implements AuthenticationClient {
  ...
  Future<KycResponse> submitKYC(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<KycResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
    ...
    final _value = KycResponse.fromJson(_result.data!);
    return _value;
  }
  ...
  Future<SignupResponse> submitSchoolAdminKYC(
    ...
    final _data = {
      ...
      'classNumberRange': classNumberRange,
      'studentNumberRange': studentNumberRange,
      'teacherNumberRange': teacherNumberRange,
    };
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SignupResponse>(Options(
      method: 'PUT',
